...
func PostHandler(sl SlugReader, tpl *template.Template) http.HandlerFunc {
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// convert the postMarkDown into a buffer (interface returns string so convert to byte slice)
		...
		err = tpl.Execute(w, PostData{
			Content: template.HTML(buf.String()), // cast the HTML string generated by Goldmark into the template.HTML type
			Author:  "Nicholas Kim",
